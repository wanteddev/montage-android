 ...
 *
 * @param topContentSkeleton 상단 콘텐츠 영역에 스켈레톤을 표시할지 여부입니다.
...
object WantedCardDefaults {
     ...
     * ```
     *
     * @param topContentSkeleton 상단 콘텐츠 영역에 스켈레톤을 표시할지 여부. 기본값은 false입니다.
     * @param captionSkeleton 메인 캡션에 스켈레톤을 표시할지 여부. 기본값은 true입니다.
     * @param extraCaptionSkeleton 추가 캡션에 스켈레톤을 표시할지 여부. 기본값은 true입니다.
     * @param bottomContentSkeleton 하단 콘텐츠 영역에 스켈레톤을 표시할지 여부. 기본값은 false입니다.
